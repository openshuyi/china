...
export function TimelineExplorer() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 relative items-start w-full">
      ...
      <section className="flex-1 w-full min-w-0 space-y-4 lg:pl-44 pr-2 lg:pr-4">
        {/* 筛选控制区：玻璃态悬浮设计 */}
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="sticky top-4 z-30 grid gap-3 md:grid-cols-2 rounded-xl border border-fd-border/50 bg-fd-background/70 p-3 backdrop-blur-xl shadow-sm"
        >
